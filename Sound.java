...
public class Sound {
    ...
    public static Clip loadSound(String filePath) {
    	//This exception handling block is implemented to handle any exception while streaming audio 
        try {
    ...
    public static void playBackgroundSound() {
    	//This exception handling block is implemented to handle three exceptions while streaming audio 
    	//1. UnsupportedAudioFileException - If file format is invalid. For example : .mp3, .mp4 etc 
    	//2. IOException - Interruption and failed operations
    	//3. LineUnavailableException - It is an exception indicating that a line cannot be opened because it is unavailable
        try {
